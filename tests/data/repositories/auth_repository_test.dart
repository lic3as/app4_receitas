  ...
  group('AuthRepository', () {
    group('currentUser', () {
      ...
      test('deve retornar erro quando fetchUserProfile falha', () async {
        ...
        expect(result.left.message, 'Erro ao carregar profile');
      });
    });
    group('signInWithPassword', () {
      ...
      test('deve retornar erro quando email não foi confirmado', () async {
        // Arrange
        when(
          mockAuthService.signInWithPassword(
            email: 'test@email.com',
        ...
        // Assert
        expect(result.isLeft, true);
        expect(result.left.message, equals('E-mail não confiirmado.'));
      });
      test(
